...
// @Param type query string true "查询类型(分页查询：page)" page
...
// @Failure 401 string "{error:{code:0,message:未授权}}"
...
// @Produces json
// @Param access-token header string false "访问令牌"
// @Param body body schema.Demo true "示例数据"
// @Success 200 string "{record_id:记录ID}"
// @Failure 400 string "{error:{code:0,message:无效的请求参数}}"
// @Failure 401 string "{error:{code:0,message:未授权}}"
// @Failure 500 string "{error:{code:0,message:服务器错误}}"
